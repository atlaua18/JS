...
let convertedNamy = namy1 + LowerStrNamy;
let convertedSurname = surname1 + LowerStrSurname;

console.log(convertedNamy + '\n' + convertedSurname);

comparison = namy + surname === convertedNamy + convertedSurname ? 'Имя осталось без изменений' : 'Имя было преобразовано';
